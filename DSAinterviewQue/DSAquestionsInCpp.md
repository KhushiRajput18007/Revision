...
(A) Remove Duplicates – Sorted Array
...
(B) Remove Duplicates – Unsorted Array

(Without using set/map/sorting) — O(n²)
...
(Pure two-array in-place, Gap Method — LeetCode-style)
...
(Default LeetCode format, no extra DS)
...
(Parents of LeetCode 1 solution)
...
So here is a strictly brute force, LeetCode-style implementation:
...
✅ 17️⃣ Longest Substring with At Most K Distinct Characters — Sliding Window

Equivalent to LeetCode 340.
...
This matches LeetCode 9 (Palindrome Number) but without using string or reverse inbuilt.
...
This is similar to LeetCode 268 but uses 1..n instead of 0..n.
